...
Четыре ключевых экрана критического пути: от выбора блюда до отслеживания доставки.

### Экран 1 - Меню (каталог)

посмотреть в корне репозитория название Catalog.png
...
просотреть в корне репозитория название Korsina.png
